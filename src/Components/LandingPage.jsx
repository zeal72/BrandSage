		...
		<div className="min-h-screen bg-white text-gray-800 font-sans scroll-smooth">
			...
			<nav className="sticky top-0 z-50 bg-white/90 backdrop-blur-sm flex justify-between items-center px-2 sm:px-4 md:px-6 lg:px-8 py-3 sm:py-4 shadow-lg">
				...
				>
					...
					<motion.a
                        ...
                        rounded-full
                        text-sm sm:text-base md:text-sm lg:text-base
                        transition-all shadow-lg hover:shadow-indigo-200
                        whitespace-nowrap
                    "
					>
						Get Started
				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
					<div className="order-2 lg:order-1">
						...
						<div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
							<AnimatedButton href="/auth" className="bg-indigo-600 text-white text-center px-4 py-2 sm:px-6 sm:py-3 md:px-8 md:py-4 text-sm sm:text-base md:text-lg">
								Start Free Trial
							</AnimatedButton>
							<AnimatedButton
								href="#demo"
			...
			<SectionWrapper className="bg-indigo-600 text-white">
				<div className="text-center">
					...
					<AnimatedButton href="/auth" className="px-6 py-3 sm:px-8 sm:py-4 md:px-10 md:py-5 text-base sm:text-lg md:text-xl">
			...
			<footer className="bg-gray-800 text-gray-300 py-4 sm:py-8 px-2 sm:px-4 md:px-6 lg:px-8">
				<div className="flex flex-col sm:flex-row justify-between items-center">
					...
					<div className="flex flex-wrap gap-2 sm:gap-4">
						...
						<a href="/auth" className="hover:text-white transition text-xs sm:text-sm">Get Started</a>
					</div>
				</div>
...
// Reusable Components (Updated with responsive classes)
...
// New NavLink Component for Animated Underline
